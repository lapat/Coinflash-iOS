...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        _displayAnimated = true;
        _lineWidth = @13;
        
        [self addCircleWithFrame:self.bounds clockwise:YES shadow:false shadowColor:[UIColor clearColor]];
    }
    return self;
}
  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        [self addCircleWithFrame:frame clockwise:clockwise shadow:hasBackgroundShadow shadowColor:backgroundShadowColor];
...
- (void)addCircleWithFrame:(CGRect)frame
                 clockwise:(BOOL)clockwise
                    shadow:(BOOL)hasBackgroundShadow
               shadowColor:(UIColor *)backgroundShadowColor {
