...
class AccountSettingsVC: UIViewController, UITableViewDataSource{
    ...
    @IBAction func didTapOnAddCoinbaseButton(sender: UIButton){
        ...
        CoinbaseOAuth.startAuthentication(withClientId: "fb8d49906184ea0934d6d60c05b2f336f94f93b30bf9708a1a77d0f7c7e10fc5", scope: "wallet:user:read,wallet:buys:create,wallet:payment-methods:read,wallet:accounts:read,wallet:transactions:send", redirectUri: "com.coinbasepermittedcoinflash1.apps.coinflash-999://coinbase-oauth", meta: ["send_limit_amount": "1.00", " send_limit_currency": "USD", "send_limit_period": "week"])
    }
    ...
    func getCoinFlashUserInfo(){
        ...
        let parameter: Parameters = ["mobile_secret": mobileSecret, "user_id_mobile": user_id_mobile, "mobile_access_token": user_mobile_access_token]
